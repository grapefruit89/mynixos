...
### 2026-02-26: traefik.nix Aggregator-Status
- Kontext: traefik-routes-public.nix fehlte, Import war broken
- Entscheidung: Lösung A (Aggregator mit auskommentiertem Import)
- Konsequenzen: Datei ist jetzt sicher vor versehentlichem Import; TODO für Implementierung angelegt.
