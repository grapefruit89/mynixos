...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.resolved = {
      enable = true; dnssec = lib.mkForce "allow-downgrade"; domains = [ "~." ]; fallbackDns = [ "1.1.1.1" "8.8.8.8" ];
      extraConfig = "DNSOverTLS=yes\nCache=yes\nCacheMaxAgeSec=86400";
    };
    boot.kernel.sysctl = {
      "net.core.default_qdisc" = lib.mkForce "fq"; "net.ipv4.tcp_congestion_control" = lib.mkForce "bbr";
      "net.core.netdev_max_backlog" = lib.mkForce 10000; "net.ipv4.tcp_slow_start_after_idle" = lib.mkForce 0;
    };
