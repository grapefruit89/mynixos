...
in
{
  options.my.meta.fail2ban = lib.mkOption {
    ...
    default = nms;
    readOnly = true;
    description = "NMS metadata for fail2ban module";
  };
  ...
  config = lib.mkIf config.my.services.fail2ban.enable {
    services.fail2ban = {
      ...
      jails = {
        ...
        caddy-auth.settings = { enabled = true; port = "http,https"; filter = "caddy-json"; backend = "systemd"; maxretry = 3; findtime = "5m"; bantime = "24h"; };
        caddy-scan.settings = { enabled = true; port = "http,https"; filter = "caddy-scan"; backend = "systemd"; maxretry = 2; findtime = "1m"; bantime = "168h"; };
      };
    };
